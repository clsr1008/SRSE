...
class TJU():
    def __init__(self):
        ...
        self.alg_hparams = {
            'UDA_KD': {'learning_rate': 1e-4, 'temperature': 4, 'cls_loss_wt': 1, 'domain_loss_wt': 1, 'errG': 1},
            'UDA_KDS': {'learning_rate': 1e-4, 'temperature': 4, 'cls_loss_wt': 1, 'domain_loss_wt': 1, 'errG': 1},
        }

class XJTU():
    def __init__(self):
        super(XJTU, self).__init__()
        self.train_params = {
                'num_epochs': 10,
                'batch_size': 256,
                'weight_decay': 1e-4,
